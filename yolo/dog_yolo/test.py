...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/dog_dataset.yaml', help='*.data path')
    ...
    parser.add_argument('--name', default='test_img_result', help='save to project/name')
